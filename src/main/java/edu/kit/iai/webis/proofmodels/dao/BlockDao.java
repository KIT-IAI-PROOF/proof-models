...
/**
 * Represents a BlockDao entity that is part of a workflow system.
 * The block contains metadata such as label, description, color, type, and position,
 * as well as relationships to other entities such as source and target handles
 * and a workflow. It is a persistent entity stored in the database.
 */
@Slf4j
@Getter
@Setter
...
@NoArgsConstructor
@Table(name = "block")
public class BlockDao extends AAuditable implements Serializable {

    @Serial
    private static final long serialVersionUID = 3247893478343L;
    ...
    /**
     * Represents the unique identifier for a template.
     * This variable is mapped to the "templateId" column in the database and
     * is serialized/deserialized for JSON operations.
     * <p>
     * The value of this field is optional and can be null.
     */
    @Nullable
    @Include
    ...
    /**
     * Represents the position associated with the entity. This field is optional
     * and may contain null values. It is stored in the database under the column
     * name "position".
     * <p>
     * The field is annotated to be embedded within the owning entity. It is
     * included in JSON serialization and deserialization processes, where it is
     ...
     * <p>
     * This list stores instances of {@link OutputDao} and provides an
