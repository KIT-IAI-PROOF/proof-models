...
/**
 * The synchronization strategy for a {@link Template} ({@link Block}).
 * Values may be {@link #WAIT_FOR_SYNC}, {@link #ALL_VALUES}, or {@link #INSTANT}
 */
public enum ESyncStrategy {
    /**
    ...
    ALL_VALUES,
    /**
     * The block forwards each output value as soon as an input value arrives
     */
    INSTANT
}
