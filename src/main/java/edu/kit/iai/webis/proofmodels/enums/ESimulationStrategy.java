 ...
 */
public enum ESimulationStrategy {
    /**
     * Abort WorkflowDao when dependent values aren't present.
     */
    ABORT,
    /**
    ...
    IGNORE,
    /**
     * Use the latest received values and continue.
     */
    LATEST,
    /**
    ...
    /**
     * Wait until all values are present and retry with the current workflow sync step (after stepBasedConfig duration).
     */
    WAIT_AND_RETRY
}
